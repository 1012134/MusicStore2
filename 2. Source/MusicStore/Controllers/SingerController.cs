...
namespace MusicStore.Controllers
{
    public class SingerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="ID,FullName,Information,LinkImage")] Singer singer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,FullName,Information,LinkImage")] Singer singer)
        {
            if (ModelState.IsValid)
            {
